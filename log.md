...
2026-09-17 --:-- | ingest | 기존 설계 문서(tech-stack, data-isolation, database, auth, order, aura-export)와 interview-needs-analysis.md를 팀 공유용 아키텍처 정의서로 종합. eli5 톤(비개발 직군용), 팀 전원 합의 전 초안 명시, 확인 필요 항목 5건 요약 | AI-Sessions/wiki/design/architecture-overview.md, AI-Sessions/wiki/projects/bizpedia-mvp.md, index.md
